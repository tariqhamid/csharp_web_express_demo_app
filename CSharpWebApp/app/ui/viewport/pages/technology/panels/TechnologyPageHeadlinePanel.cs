...
namespace CSharpWebApp.app.viewport.pages.technology.panels
{
    public class TechnologyPageHeadlinePanel : Bp2Columns
    {
        public TechnologyPageHeadlinePanel(IWidget widget) : base(widget)
        {
        }
